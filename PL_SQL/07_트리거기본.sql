...
INSERT INTO tbl_test VALUES(1, '김철수'); -- 트리거 동작 안했음
UPDATE tbl_test SET text = '김개똥' WHERE id = 1; -- 트리거 동작 했음
DELETE FROM tbl_test WHERE id = 1; -- 트리거 동작 했음
-- update, delete 이후에 트리거 동작함 조건을 그렇게 설정
