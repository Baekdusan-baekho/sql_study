...
GRANT UPDATE ON hr.departments TO user1;
...
QUOTA UNLIMITED ON user_tablespace; -- 데이터 크기 무제한
...
--------------------------------------------------------------------
-- CONNECTION 을 run sql command line 에 해야 계정이 접속된다 그리고
-- GRANT CREATE SESSION TO user1; 을 줘야 한다
