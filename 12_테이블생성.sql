...
- 시, 분, 초 지원 가능.
*/
-- 롤백해도 CREATE ALTER DROP은 롤백되지 않는다
CREATE TABLE dept2 (
    dept_no NUMBER(2),
...
INSERT INTO dept2
VALUES(30, '경영지원', '경기', sysdate, 20000000000);
(20, '영업', '서울', sysdate, 2000000)
(300, '경영지원', '경기도', sysdate, 2000000)
(20, '영업', '서울', sysdate, 2000000)
(30, 'asdkfaskldfjlaskdf', '경기', sysdate, 2000000)
(30, '아직생각해놓은부서이름은없는부서', '경기', sysdate, 2000000)
...
ALTER TABLE dept2
RENAME COLUMN EMP_COUNT TO dept_count;

-- 열 속성 수정
-- 만약 변경하고자 하는 컬럼에 데이터가 이미 존재한다면 그에 맞는 타입으로
-- 변경해 주셔야 합니다. 맞지 않는타입으로는 변경이 불가능합니다.
ALTER TABLE dept2
